    ...
    return (
        <div className='flex justify-between items-center bg-white p-3 rounded'>
            <div className='flex gap-5 items-center'>
                ...
                <img className='h-[80px] rounded-xl border border-gray-300' src={installedApp.image} alt="" />
                <div className='flex flex-col gap-3'>
                    <h3 className='font-semibold'>{installedApp.title}</h3>
                    <div className='flex gap-5'>
                        <span className='badge badge-soft badge-success text-xs'><img className='h-[12px]' src={downIcon} alt="" />{installedApp.downloads / 100000} M</span>
                        <div className="badge badge-soft bg-[#FFF0E1] border-0 text-xs text-[#FF8811]"> <img className='h-[12px]' src={starIcon} alt="" /> {installedApp.reviews} </div>
                    </div>
                </div>
